...
# creating a average for each range
  ...
  # delete the "#" below if you want to see errorbar
   pl <- ggplot(avg.data, aes(x = Vern, y = mean_log2_cpm, color = Pop, group = Pop)) +
...
plotDE_line("Sdiv_ptg000001l_0001-R",dge.data_Normalization_dispersions,sample.description_data)
plotDE_line(rownames(Pop_Vern_gene)[1:3],dge.data_Normalization_dispersions,sample.description_data)
