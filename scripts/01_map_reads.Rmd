...
```{bash}
cd /share/malooflab/Julin/git/Strep-tort-vernalization/intermediate

find /share/malooflab/Fastqs/Dimensions/hydrothermal_2022-09-20-apex1-redo/good | grep -E "_R1_.fastq.gz" > R1_fastqs.txt


find /share/malooflab/Fastqs/Dimensions/hydrothermal_2022-09-20 | grep -E "Apex.*_R1_.*fastq\.gz$"  >> R1_fastqs.txt
